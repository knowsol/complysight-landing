          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="mt-14 grid lg:grid-cols-[0.95fr_1fr] gap-12 lg:gap-20 items-center">
              ...
              <div className="text-slate-600 leading-loose" style={{ wordBreak: 'keep-all' }}>
                ...
                <p className="mt-6 text-lg">
                  이처럼 <mark className="px-1 py-0.5 -mx-0.5 rounded-sm" style={{ background: 'rgba(148, 163, 184, 0.3)', boxDecorationBreak: 'clone', WebkitBoxDecorationBreak: 'clone', color: 'inherit' }}>
                    정부 기준에서도 <strong className="font-semibold text-slate-900">자동화 기반 점검 체계 도입을 권고</strong>하고 있으며
                  </mark>,
                  이에 따라 <mark className="px-1 py-0.5 -mx-0.5 rounded-sm" style={{ background: 'rgba(148, 163, 184, 0.3)', boxDecorationBreak: 'clone', WebkitBoxDecorationBreak: 'clone', color: 'inherit' }}>
